...
```{r testit_test1, test = TRUE}
library(testit)
y <- 10
testit::assert("This is the number ten.", y == 10)
```

```{r testit_test2, test = TRUE}
testit::assert("This is the number nine.", y == 9)
```
